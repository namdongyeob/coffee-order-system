...
- 묶음 결과는 57 tests, failures 0, errors 0, skipped 0이며 HTML report가 생성됐습니다.
- 별도 clean 프로세스의 `RankingRebuildServiceIntegrationTest` 결과는 10 tests, failures 0, errors 0, skipped 0입니다.
