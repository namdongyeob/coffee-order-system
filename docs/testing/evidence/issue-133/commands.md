...
| 3 | `./gradlew test --tests "*DltReplayServiceIntegrationTest" --no-daemon` | 타임아웃/락 해제 개별 테스트 수행 (Level 4/5) | 성공 |
| 4 | `./gradlew test --no-daemon` | 전체 통합 테스트 로컬 수행 (Level 4/5) | 150개 통과 |
