...
| 2026-07-16 | Issue #112 Rebuild ledger 연동 | Level 1 | PASS | Rebuild 27 tests, 관련 Ranking·PopularMenu 50 tests, 전체 106 tests | `commands.md` | 모두 failures=0, errors=0, skipped=0입니다. |
...
| 2026-07-16 | Issue #112 Rebuild ledger 연동 | Level 5 | PASS | 실제 Compose MySQL·Kafka·Redis와 로컬 앱의 최초 rebuild 및 PREPARED marker 복구 | `manual-qa.md` | Attempt 4에서 same run, input 0 recovery, current=end=1, lag 0, score 1을 확인했으며 Attempt 5에서는 사용자 지시에 따라 반복하지 않았습니다. |
