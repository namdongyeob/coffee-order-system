...
- Review 결함 수 2는 첫 Review P1과 remediation head의 두 번째 P1이며, QA 결함은 아직 없습니다. 사용자 수동 시각 QA, fresh Review, QA, CI는 pending입니다.
...
- Review/QA/CI: 사용자 수동 시각 QA evidence 제공 후 재개합니다.
