...
- [x] 동일 eventId와 동일 핵심 payload는 한 번만 집계됩니다.
- [x] 동일 eventId와 다른 핵심 payload는 fail-closed 합니다.
- [x] 입력, 고유 event, 충돌 수를 결과 또는 로그에서 관찰할 수 있습니다.
- [x] Level 4 실제 Kafka와 Redis focused test가 PASS 입니다.
- [x] Level 5 rebuild runner 실행이 PASS 입니다.
