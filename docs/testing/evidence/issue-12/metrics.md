...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| STRICT | 4 | 11 | 1 | 0 | 0 | 0 | 0 | 8 |

## 측정 근거

- 최초 Generate 시작은 `2026-07-12T20:09:16+09:00`, 마지막 live PR body Reverification 종료는 `2026-07-12T20:20:00+09:00`이며 실제 경과 10분 44초를 분 단위 올림해 11분으로 기록했습니다.
